...
import SignImg from "/img/png/singupimg.png";
const Register = () => {
	const {
		logInWithGoogle,
		createUserWithEmail,
	...
	return (
		<section className="register-area my-20">
			<div className="container mx-auto">
				<div className="flex">
					<div className="w-6/12">
						<img src={SignImg} alt="singImg" />
					</div>
					<div className="w-6/12 max-w-lg p-10 rounded-md shadow sm:p-8">
						<h2 className="mb-3 text-3xl font-semibold">Sign Up</h2>

						<form className="space-y-8 p-10" onSubmit={handleSubmission}>
							...
							<button
								type="submit"
								className="w-full px-8 py-3 font-semibold rounded-md btn-primary hover:btn-secondary"
							>
								Sign Up
							</button>
						</form>
